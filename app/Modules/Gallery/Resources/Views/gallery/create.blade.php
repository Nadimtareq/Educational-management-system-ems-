...
@section('content')
            ...
            <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
                <div class="uk-width-large-10-10">
                    <form action="{{ route('gallery_store') }}" method="post" enctype="multipart/form-data" class="uk-form-stacked" id="user_edit_form">
                            ...
                            <div class="uk-width-large-10-10">
                                <div class="md-card">
                                    <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                                        ...
                                        <div class="user_heading_content">
                                            <h2 class="heading_b"><span class="uk-text-truncate" id="user_edit_uname"> New Gallery</span></h2>
                                        </div>
                                    </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-6">
                                        <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="category" id="customer_name" name="category">
                                            <option value="">category </option>
                                            @foreach($gallery as $item)
                                                <option value="{{ $item->id }}">{{ $item->c_id }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
