...
@section('content')
        ...
        <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
            ...
            <tr>
             <th></th>
                ...
                <th data-priority="2">end date</th>
            ...
            @foreach($leave as $value)
                <tr>
                    ...
                    <td class="uk-text-center">
                        <a href="{{ route('leave_edit',$value->id) }}" data-uk-tooltip title="edit Item" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                        <a onclick="deleterow(this); return false" href="{{ route('leave_delete',$value->id) }}" data-uk-tooltip title="delete Item" class="batch-delete"><i class="md-icon material-icons">&#xE872;</i></a>
    ...
    <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent" href="{{ route('leave_create') }}">
