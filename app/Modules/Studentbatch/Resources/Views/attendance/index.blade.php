...
@section('content')
    ...
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-content">
            <form action="{{ route('studentattendance_update') }}" method="post">
                {{ csrf_field() }}
         ...
         <div class="uk-grid" data-uk-grid-margin>
             ...
             <button type="submit" class="md-btn md-btn-primary md-btn-block md-btn-wave-light waves-effect waves-button waves-light" id="button">Update</button>
             </div>
         </div>
       </form>
            <div class="md-fab-wrapper">
                <a class="md-fab md-fab-accent" href="{{ route('studentattendance_create') }}" id="recordAdd">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#filter").on('click',function() {
                ...
                var data = '';
                $.ajax({
                    url: "{{ route('studentattendance_getAllStudentByDate') }}",
                    type: "GET",
                    data: {stuclass: stuclass,stusession:stusession,stusection:stusection,selected_date:attendancedate},
                    ...
                    success: function (data, text) {
                           ...
                           if(_.isEmpty(data)){
                               ...
                               $('#dt_search').html("<div style='text-align: center;'>No Data Found</div>");
