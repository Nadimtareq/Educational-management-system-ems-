...
@section('content')
                            ...
                            @foreach( $cteacher as $value)
                                ...
                                <td></td>
                                    ...
                                    <td class="uk-text-center">
                                        <a href="{{ route('cteacher_edit',$value->id) }}" data-uk-tooltip title="edit Item" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                        <a onclick="deleterow(this); return false" href="{{ route('cteacher_delete',$value->id) }}" data-uk-tooltip title="delete Item" class="batch-delete"><i class="md-icon material-icons">&#xE872;</i></a>
    ...
    <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent" href="{{ route('cteacher_create') }}">
