          ...
          @foreach($subject as $value)
            <tr>
                ...
                <td class="uk-text-center">
                    ...
                    <a onclick="deleterow(this); return false" href="{{ route('subject_delete', $value->id)}}" data-uk-tooltip title="delete Item" class="batch-delete"><i class="md-icon material-icons">&#xE872;</i></a>
