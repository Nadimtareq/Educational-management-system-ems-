...
@section('content')
    <form action="{{ route('dailyaccounts_store') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <div class="md-card">
                    <div class="md-card-content">
                        <h3 class="heading_a uk-margin-small-bottom">
                            Daily Accounts | <a href="{{ route('dailyaccounts') }}"><i class="md-icon material-icons"></i></a>
                        </h3>
                        ...
                        <div class="uk-width-medium-1-1">
                            ...
                            <div class="uk-input-group">
                                ...
                                <input class="md-input" type="text" name="newdate" data-uk-datepicker="{format:'YYYY-MM-DD'}">
                        ...
                        <div class="uk-width-medium-1-2" >
                            <div class="uk-input-group">
                                ...
                                <span class="icheck-inline">
                                        <input type="radio" name="ix" value="1" checked id="radio_demo_inline_1" data-md-icheck />
                                        <label for="radio_demo_inline_1"  class="inline-label">&nbsp;Income</label>
                                    </span>
                                <span class="icheck-inline">
                                        <input type="radio" name="ix" value="0" id="radio_demo_inline_2" data-md-icheck />
                        ...
                        <div class="uk-width-medium-1-1">
                            ...
                            <div class="uk-input-group">
                                ...
                                <input size="40" class="md-input" id="contact" type="text" name="contact">
                    ...
                    <div class="md-card-content">
                        ...
                        <div class="uk-width-medium-1-2">
                            ...
                            <div class="uk-input-group">
                                ...
                                <input readonly class="md-input" type="text" id="Student_name" style="border: none">
                            </div>
                            <div class="uk-input-group">
                                <span class="uk-input-group-addon">Email:</span>

                                <input readonly class="md-input" type="text" style="border: none" id="student_email">
                            </div>
                            <div class="uk-input-group">
                                <span class="uk-input-group-addon">Phone:</span>

                                <input readonly class="md-input" type="text" style="border: none" id="student_phone">
                            </div>
                            <div class="uk-input-group">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-2">
                                        <div class="uk-form-row">
                                            <label>Amount</label>
                                            <input required type="text" name="amount" class="md-input"  />
                        ...
                        <div class="uk-input-group ">
                            <button type="submit" style="margin-left: 20px"  class="md-btn md-btn-success md-btn-wave-light waves-effect waves-button waves-light" >Save</button>
                        </div>
                        <br/>
