...
<form action="{{ route('teacher_student_result_store') }}" method="post" >
    {{ csrf_field() }}
    <div class="md-card">
            ...
            <div class="uk-overflow-container">
                <table class="uk-table">
                    ...
                    <tr>
                        ...
                        <td width="40%"><input name="user_id[]" type="hidden" value="{{ $value->user_id }}"> {{ $value->user->first_name }}</td>
                        <td width="12%" align="right"><input name="mark[]" size="10" type="number" min="0" maxlength="3" max="100" value="0" ></td>
                    </tr>
                    @endforeach
