            ...
            <div>
                <div class="md-card payment">
                    <div class="md-card-content padding-reset" >
                        <div style="" class="pricing_table_plan md-bg-pink-500 md-color-white">Total Paid</div>
...
--}}
            ...
            <div>
                <div class="md-card payment">
                    <div class="md-card-content padding-reset" >
                        <div style="" class="pricing_table_plan md-bg-orange-500 md-color-white">Current batch</div>
                        <div class="pricing_table_price">
                            @foreach($batch as $item)
                                   <h6> Class : {{ $item->studentclass->name }} </h6>
                                    <h6>Session: {{ $item->session->title }}  </h6>
                                    <h6>Section :  {{ $item->section->name }}</h6>
