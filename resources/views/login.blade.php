...
<div class="login_page_wrapper">
        ...
        <div class="md-card-content large-padding" id="login_form">
            ...
            <form action="{{ route('Auth') }}" method="post">
                <div class="uk-form-row">
                    ...
                    <input class="md-input" type="text" id="login_username" name="login_email" required/>
                </div>
                <div class="uk-form-row">
                ...
                <div class="uk-margin-top">
                    ...
                    <span class="icheck-inline">
                            ...
                            <label for="login_page_stay_signed" class="inline-label">Stay signed in</label>
                              <a class="inline-label" href="{{ route('forgotpassword') }}">Forgot Password ?</a>
                        </span>
                </div>
            </form>
        </div>
    ...
    @if(Sentinel::forceCheck())
        <div class="uk-margin-medium-top">
              ...
              <a href="{{ route('Auth_logout') }}" class="md-btn md-btn-primary md-btn-block md-btn-large">Sign Out</a>
        </div>
